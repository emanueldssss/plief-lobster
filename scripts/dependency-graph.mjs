...
const project = resolve(projectArg); const extensions = ["", ".html", ".ts", ".tsx", ".js", ".jsx", ".css", ".scss"];
...
const graph = {schema: "lobster-dependency-graph/v2", project: ".", entries: [relative(project, resolve(project, entryArg)).replaceAll("\\", "/")], nodes: sortedNodes, edges: sortedEdges, confidence: "FULL", fingerprint};
